...
if((profile.authority_pillars||[]).length!==8) bad.push('authority pillar count');
...
console.log('Authority system OK: 8 pillars, entity graph, autonomy and ownership contracts');